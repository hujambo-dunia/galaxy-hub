...
export default {
    ...
    methods: {
        ...
        exitOnQueryCharsMin(query) {
            // TODO refactor - should prevent any search-queries from running if minimum characters not met
            if (QUERY_CHARS_MIN < query.length) {
                return;
            }
        },
    },
